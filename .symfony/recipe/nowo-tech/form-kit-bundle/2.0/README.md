# Form Kit Bundle — Flex recipe (2.0)

Stub for [symfony/recipes-contrib](https://github.com/symfony/recipes-contrib).
...
See [docs/RECIPE.md](../../../../docs/RECIPE.md) in this repository.
